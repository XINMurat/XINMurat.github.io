...
<section class="hero">
  <div class="wrap">
    ...
    two of the three artefacts behind this page are unpublished working files —
    see <em>The artefacts</em> at the end.</p>
  </div>
</section>
...
<section class="block">
  <div class="wrap">
    ...
    <ul class="plain">
      ...
      <li><code>mizan-product-registry.yaml</code> and <code>refuted-patterns.yaml</code> — <strong>not published.</strong> Both are gitignored working files, so <code>YZ-001</code>…<code>YZ-004</code>, the escape <code>ESC-M003</code> and the six refuted patterns exist on one machine and cannot be checked by a reader. Every claim on this page that rests on them is author-reported and carries the same permanent <code>[KKE]</code> as the rest.</li>
...
<section class="hero">
  <div class="wrap">
    ...
    bu sayfanın dayandığı üç artefaktın ikisi yayınlanmayan çalışma dosyası —
    sondaki <em>Artefaktlar</em> bölümüne bakın.</p>
  </div>
</section>
...
<section class="block">
  <div class="wrap">
    ...
    <ul class="plain">
      ...
      <li><code>mizan-product-registry.yaml</code> ve <code>refuted-patterns.yaml</code> — <strong>yayınlanmıyor.</strong> İkisi de gitignore'lu çalışma dosyası; dolayısıyla <code>YZ-001</code>…<code>YZ-004</code>, <code>ESC-M003</code> kaçağı ve altı çürütülmüş örüntü tek bir makinede duruyor ve okuyucu tarafından denetlenemiyor. Bu sayfada onlara dayanan her iddia yazar-beyanıdır ve geri kalanla aynı kalıcı <code>[KKE]</code>'yi taşır.</li>
